...
export default function ReceptionistVisitorsPage() {
  ...
  const handleCheckOut = async (visitorId: string) => {
    try {
      ...
      toast({ variant: "destructive", title: "Error checking out" })
    }
  }
  ...
  const handleLogVisitor = async () => {
    try {
      ...
      if (response.ok) {
        ...
        toast({ variant: "destructive", title: "Failed to log visitor" })
      }
    } catch (error) {
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Log and monitor visitor entries and exits</p>
          </div>
            ...
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                ...
                <div>
                  ...
                  <Input id="flatNumber" value={newVisitor.flatNumber} onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="vehicleNumber">Vehicle (Optional)</Label>
